...
public class MusicWidget extends RelativeLayout {
	...
	inflater.inflate(R.layout.keyguard_screen_media_controller,this,true);
	mMainLayout = (RelativeLayout) findViewById(R.id.musicwidget_root);
	...
	mAlbumArtWithImage = (ImageView) findViewById(R.id.AlbumArtWithImage);
	...
	mNextButton = (ImageButton) findViewById(R.id.MusicBoxForward);
	mPlayButton = (ImageButton) findViewById(R.id.MusicBoxPlay);
	mPauseButton = (ImageButton) findViewById(R.id.MusicBoxPause);
	mBeforeButton = (ImageButton) findViewById(R.id.MusicBoxRewind);
    ...
    public void onResume(){
      Log.d("LockScreenMusicWidget",new StringBuilder().append("onResume() isTopLayout=").append(isTopLayout).append(", isMaxLayout=").append(isMaxLayout).toString());
      mHeightDifference = mMaxMusicController.getHeight() - mMinMusicControllerHandle.getHeight();
    ...
    public void setControllerVisibility(boolean bIsVisible, boolean isMusicWidgetShowed){
      Log.d("LockScreenMusicWidget",new StringBuilder().append("setControllerVisibility() : bIsVisible=").append(bIsVisible).append(", mVisibleLayout=").append(mVisibleLayout).toString());
	...
	int[] randomCovers = {
	  R.drawable.unlock_music_play_grid_thumb_01,
	  R.drawable.unlock_music_play_grid_thumb_02,
	  R.drawable.unlock_music_play_grid_thumb_03,
	  R.drawable.unlock_music_play_grid_thumb_04,
	  R.drawable.unlock_music_play_grid_thumb_05,
	  R.drawable.unlock_music_play_grid_thumb_06,
	  R.drawable.unlock_music_play_grid_thumb_07,
	  R.drawable.unlock_music_play_grid_thumb_08,
	  R.drawable.unlock_music_sound_bg,
	  R.drawable.unlock_music_sound_bg_f,
	  R.drawable.unlock_music_sound_bg_p
	};
	...
	if(!mScreenOn || (currentTitle == null && currentArtist == null)){
	  mMusicInfoTextInMax.setText("");
	  mMusicInfoTextInMin.setText("");
	  mMusicInfoTextInMax.setSelected(false);
	  mMusicInfoTextInMin.setSelected(false);
    ...
    protected void onDestroy() {
      ...
      unbindDrawables(findViewById(R.id.musicwidget_root));
      System.gc();
    }
